...
const Navbar = () => {
  ...
  return (
    <nav className='flex flex-wrap justify-between bg- bluemd:items-center text-white px-10 pt-6 md:px-20'>

      <span className='text-xl font-bold tracking-wide'>Portfolio</span>
      <ul 
      className={` ${menu ? "block" : "hidden"}mx-24 p-y2 mt-4 font-semibold md:mt-5 bg-black-300 px-2 rounded-xl bg-opacity-30 md:border-none
